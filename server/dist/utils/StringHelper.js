...
const generateTitleCase = (title) => {
  ...
  titleSplitted.forEach(function (word) {
    if (word) {
      tmpWordList.push(word.charAt(0).toUpperCase() + word.substring(1))
    }
  })
  // Directly return the joined string
  return tmpWordList.join(' ')
} // _generateTitleCase()

const generateSentenceCase = (title) => {
  if (typeof title !== 'string') {
    return ''
  }
  ...
  titleSplitted.forEach(function (word, idx) {
    ...
    if (idx === 0) {
      ...
      tmpWordList.push(word)
    }
  })
  // Directly return the joined string
  return tmpWordList.join(' ')
} // _generateSentenceCase()

const getCustomSlug = _generateSlug

const getLocale = (lang, country) => {
  const arrLocale = []
...
exports.decode = decode; exports.encode = encode; exports.generateSentenceCase = generateSentenceCase; exports.generateTitleCase = generateTitleCase; exports.getCustomSlug = getCustomSlug; exports.getLocale = getLocale; exports.getSlug = getSlug; exports.getSlugWithoutDash = getSlugWithoutDash; exports.getUnsignedLetters = getUnsignedLetters; exports.hashCode = hashCode;
