  ...
  const _allRequestHandler = () => {
    ...
    _app.get('*param', async function (req, res, next) {
      if (req.url.startsWith('/api')) {
        return res
          .status(404)
          .sendFile(_path2.default.resolve(__dirname, '../../../404-not-found.html'))
      }
      ...
      const { enableToCrawl, enableToCache } = (() => {
        const url = _FormatUrl.convertUrlHeaderToQueryString.call(void 0, 
        ...
        const crawlOptionPerRoute =
          ...
          _optionalChain([_serverconfig2.default, 'access', _6 => _6.crawl, 'access', _7 => _7.custom, 'optionalCall', _8 => _8(url)])
      ...
      if (
        ...
        return res
          .status(403)
          .sendFile(_path2.default.resolve(__dirname, '../../../403-forbidden.html'))
      }
      ...
      if (pointsTo) {
        const url = _FormatUrl.convertUrlHeaderToQueryString.call(void 0, pointsTo, res, false)
      ...
      if (headers.accept === 'application/json') {
        ...
        const apiStoreData = await (async () => {
          ...
          const cookies = _CookieHandler.getCookieFromResponse.call(void 0, res)
          const deviceType = _optionalChain([cookies, 'optionalAccess', _12 => _12['DeviceInfo'], 'optionalAccess', _13 => _13['type']])
    ...
    _app.use(function (err, req, res, next) {
      ...
      res
        .status(500)
        .sendFile(_path2.default.resolve(__dirname, '../../../500-server-error.html'))
    })
  }
