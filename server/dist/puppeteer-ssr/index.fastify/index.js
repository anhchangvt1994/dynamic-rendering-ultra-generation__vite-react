...
,
        ...
        const { enableToCrawl, enableToCache } = (() => {
          ...
          const crawlOptionPerRoute =
            ...
            _optionalChain([_serverconfig2.default, 'access', _14 => _14.crawl, 'access', _15 => _15.custom, 'optionalCall', _16 => _16(url)])
        ...
        const pointsTo = _optionalChain([_serverconfig2.default, 'access', _17 => _17.routes, 'optionalAccess', _18 => _18[correctPathname], 'optionalAccess', _19 => _19.pointsTo])
        ...
        if (headers.accept === 'application/json') {
          ...
          const apiStoreData = await (async () => {
            ...
            const cookies = _CookieHandler.getCookieFromResponse.call(void 0, res)
            const deviceType = _optionalChain([cookies, 'optionalAccess', _20 => _20['DeviceInfo'], 'optionalAccess', _21 => _21['type']])
