...
const fetchCache = (() => {
  return (cacheKey) =>
    new Promise((res) => {
      setTimeout(async () => {
        const apiCache = await _utils.getLRUCacheData.call(void 0, cacheKey)
...
, 'optionalAccess', _9 => _9.replace, 'call', _10 => _10(/requestInfo=([^&]*)/g, '')])
        ...
        if (enableCache) {
          const apiCache = await _utils.getLRUCacheData.call(void 0, requestInfo.cacheKey)
          ...
          if (apiCache) {
            ...
            if (
                ...
                if (!apiCache || apiCache.status !== 'fetch') {
                  ...
                  _FetchManager.fetchData.call(void 0, fetchUrl, {
                    ...
                    const enableToSetCache =
                      ...
                      apiCache.cache.status !== 200
                    if (enableToSetCache) {
                      _utils.setLRUCacheData.call(void 0, 
                        requestInfo.cacheKey,
                        {
                          url: fetchUrl,
                          method,
                      ...
                      _utils.compressDataAndSaveToLRUCache.call(void 0, requestInfo.cacheKey, data)
                    }
                  })
                }
              }
              ...
              const data = await _utils.getLRUCacheDataCompression.call(void 0, 
                requestInfo.cacheKey,
                contentEncoding 
              )
        ...
        if (!res.writableEnded) {
          ...
          if (enableCache) {
            _utils.setLRUCacheData.call(void 0, requestInfo.cacheKey, '', {
              isCompress: false,
              status: 'fetch',
            })
          ...
          let dataToSend = await _utils.getLRUCacheDataCompression.call(void 0, 
            requestInfo.cacheKey,
            contentEncoding 
          )
