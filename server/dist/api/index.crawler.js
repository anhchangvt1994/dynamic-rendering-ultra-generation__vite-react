  ...
  switch (true) {
    case result.status === 200:
      return contentEncoding === 'br'
        ? _zlib.brotliCompressSync.call(void 0, result.data)
        : contentEncoding === 'gzip'
          ? _zlib.gzipSync.call(void 0, result.data)
          : result.data
    default:
...
, 'access', _5 => _5.url, 'call', _6 => _6()
, 'access', _7 => _7.split, 'call', _8 => _8('?'), 'access', _9 => _9[1]
, 'optionalAccess', _10 => _10.replace, 'call', _11 => _11(/requestInfo=([^&]*)/g, '')])
